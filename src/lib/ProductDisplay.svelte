...
<section class="grid grid-cols-3 m-12">
	{#each products as product}
		<div class="m-2 bg-white/40 h-full rounded-lg shadow-md flex flex-col gap-2">
			...
			<a
				...
				class="mx-auto flex items-center gap-2 p-1.5 bg-[#B07156] rounded hover:bg-opacity-80 duration-200 outline-none disabled:opacity-60 transition w-1/3 justify-center"
				>View</a
			>
			{#if product.collection}
				<div class="flex justify-center">
					<p>
						Part of the <a href="/shop/collection/{product.collection.handle}" class="underline hover:decoration-dotted transition-all"
