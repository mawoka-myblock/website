<div class="flex justify-center px-6 lg:px-0">
	<div class="lg:w-2/3">
		...
		<ul class="index">
			<li><a class="underline text-blue-800" href="#m3">Verantwortlicher</a></li>
			<li><a class="underline text-blue-800" href="#mOverview">Übersicht der Verarbeitungen</a></li>
			<li><a class="underline text-blue-800" href="#m2427">Maßgebliche Rechtsgrundlagen</a></li>
			<li><a class="underline text-blue-800" href="#m27">Sicherheitsmaßnahmen</a></li>
			<li>
				<a class="underline text-blue-800" href="#m12"
					>Allgemeine Informationen zur Datenspeicherung und Löschung</a
				>
			</li>
			<li><a class="underline text-blue-800" href="#m10">Rechte der betroffenen Personen</a></li>
			<li><a class="underline text-blue-800" href="#m317">Geschäftliche Leistungen</a></li>
			<li><a class="underline text-blue-800" href="#m326">Zahlungsverfahren</a></li>
			<li>
				<a class="underline text-blue-800" href="#m225"
					>Bereitstellung des Onlineangebots und Webhosting</a
				>
			</li>
			<li><a class="underline text-blue-800" href="#m134">Einsatz von Cookies</a></li>
			<li><a class="underline text-blue-800" href="#m367">Registrierung, Anmeldung und Nutzerkonto</a></li>
			<li><a class="underline text-blue-800" href="#m104">Blogs und Publikationsmedien</a></li>
			<li><a class="underline text-blue-800" href="#m182">Kontakt- und Anfrageverwaltung</a></li>
			<li><a class="underline text-blue-800" href="#m263">Webanalyse, Monitoring und Optimierung</a></li>
			<li><a class="underline text-blue-800" href="#m135">Affiliate-Programme und Affiliate-Links</a></li>
			<li><a class="underline text-blue-800" href="#m15">Änderung und Aktualisierung</a></li>
		</ul>
		<h2 id="m3" class="text-3xl">Verantwortlicher</h2>
		<p>Kontakt</p>
		<p>E-Mail-Adresse: <a href="mailto:dataprivacy@mawoka.eu">dataprivacy@mawoka.eu</a></p>
		<p>Impressum: <a href="/legal/impressum" class="underline text-blue-800">mawoka.eu/legal/impressum</a></p>

		<h2 id="mOverview" class="text-3xl">Übersicht der Verarbeitungen</h2>
		<p>
			Die nachfolgende Übersicht fasst die Arten der verarbeiteten Daten und die Zwecke ihrer
			Verarbeitung zusammen und verweist auf die betroffenen Personen.
		</p>
		<h3 class="text-xl">Arten der verarbeiteten Daten</h3>
		<ul>
			<li>Bestandsdaten.</li>
			<li>Zahlungsdaten.</li>
			<li>Kontaktdaten.</li>
		...
		<h3 class="text-xl">Kategorien betroffener Personen</h3>
		<ul>
		...
		<h3 class="text-xl">Zwecke der Verarbeitung</h3>
		<ul>
		...
		<h2 id="m2427" class="text-3xl">Maßgebliche Rechtsgrundlagen</h2>
		<p>
		...
		<h2 id="m27" class="text-3xl">Sicherheitsmaßnahmen</h2>
		<p>
		...
		<p>
			...
			"IP-Masking" bezeichnet). Hierbei werden die letzten beiden Ziffern, bzw. der letzte
			Teil der IP-Adresse nach einem Punkt entfernt, bzw. durch Platzhalter ersetzt. Mit der
			Kürzung der IP-Adresse soll die Identifizierung einer Person anhand ihrer IP-Adresse
		...
		<h2 id="m12" class="text-3xl">Allgemeine Informationen zur Datenspeicherung und Löschung</h2>
		<p>
			...
			<li>
				...
				<ul class="list-disc">
					...
					<li>
						...
						z. B. Stundenlohnzettel, Betriebsabrechnungsbögen, Kalkulationsunterlagen,
						Preisauszeichnungen, aber auch Lohnabrechnungsunterlagen, soweit sie nicht
						bereits Buchungsbelege sind und Kassenstreifen (§ 147 Abs. 3 i. V. m. Abs. 1
						Nr. 2, 3, 5 AO, § 257 Abs. 1 Nr. 2 u. 3, Abs. 4 HGB).
					</li>
					<li>
		...
		<h2 id="m10" class="text-3xl">Rechte der betroffenen Personen</h2>
		<p>
		...
		<ul class="list-disc">
			...
			<li>
				...
				einer Aufsichtsbehörde, insbesondere in dem Mitgliedstaat ihres gewöhnlichen Aufenthaltsorts,
		...
		<h2 id="m317" class="text-3xl">Geschäftliche Leistungen</h2>
		<p>
		...
		<ul class="list-disc">
			<li>
				...
				Rechnungen, Zahlungshistorie); Kontaktdaten (z. B. Post- und E-Mail-Adressen oder Telefonnummern);
				Vertragsdaten (z. B. Vertragsgegenstand, Laufzeit, Kundenkategorie); Nutzungsdaten (z.
				B. Seitenaufrufe und Verweildauer, Klickpfade, Nutzungsintensität und -frequenz, verwendete
				Gerätetypen und Betriebssysteme, Interaktionen mit Inhalten und Funktionen). Meta-, Kommunikations-
				und Verfahrensdaten (z. B. IP-Adressen, Zeitangaben, Identifikationsnummern, beteiligte
				Personen).
			</li>
			<li>
			...
			<li>
				<strong>Zwecke der Verarbeitung:</strong> Erbringung vertraglicher Leistungen und Erfüllung
				vertraglicher Pflichten; Sicherheitsmaßnahmen; Kommunikation; Büro- und Organisationsverfahren;
		...
		<ul class="list-disc">
			<li>
				<strong>Onlineshop, Bestellformulare, E-Commerce und Auslieferung: </strong>Wir
				verarbeiten die Daten unserer Kunden, um ihnen die Auswahl, den Erwerb, bzw. die
				Bestellung der gewählten Produkte, Waren sowie verbundener Leistungen, als auch
				deren Bezahlung und Zustellung, bzw. Ausführung zu ermöglichen. Sofern für die
				...
				gegenüber unseren Kunden durchzuführen. Für die Abwicklung der Zahlungsvorgänge
				nehmen wir die Dienste von Banken und Zahlungsdienstleistern in Anspruch. Die
				erforderlichen Angaben sind als solche im Rahmen des Bestell- bzw. vergleichbaren
				...
				<span class=""
					...
					(Art. 6 Abs. 1 S. 1 lit. b) DSGVO).</span
				>
			</li>
		</ul>
		<h2 id="m326" class="text-3xl">Zahlungsverfahren</h2>
		<p>
		...
		<ul class="list-disc">
			<li>
				<strong>Verarbeitete Datenarten:</strong> Bestandsdaten (z. B. der vollständige Name,
				Wohnadresse, Kontaktinformationen, Kundennummer, etc.); Zahlungsdaten (z. B. Bankverbindungen,
				Rechnungen, Zahlungshistorie); Vertragsdaten (z. B. Vertragsgegenstand, Laufzeit, Kundenkategorie);
			...
			<li>
				<strong>Betroffene Personen:</strong> Leistungsempfänger und Auftraggeber; Geschäfts-
		...
		<ul class="list-disc">
			<!-- <li>
				<strong>Klarna: </strong>Zahlungsdienstleistungen (technische Anbindung von
				Online-Bezahlmethoden); <strong>Dienstanbieter:</strong> Klarna Bank AB (publ),
			...
			<li>
				<strong>Stripe: </strong>Zahlungsdienstleistungen (technische Anbindung von
				Online-Bezahlmethoden); <strong>Dienstanbieter:</strong> Stripe, Inc., 510 Townsend
		...
		<ul class="list-disc">
			...
			<li>
				...
				von Informationssystemen und technischen Geräten (Computer, Server etc.).). Sicherheitsmaßnahmen.
			</li>
			<li>
				<strong>Aufbewahrung und Löschung:</strong> Löschung entsprechend Angaben im Abschnitt
				"Allgemeine Informationen zur Datenspeicherung und Löschung".
		...
		<ul class="list-disc">
			...
			<li>
				...
				<span class=""
					><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit.
					f) DSGVO).
				</span><strong>Löschung von Daten:</strong> Logfile-Informationen werden für die Dauer
				von maximal 30 Tagen gespeichert und danach gelöscht oder anonymisiert. Daten, deren
				weitere Aufbewahrung zu Beweiszwecken erforderlich ist, sind bis zur endgültigen Klärung
			...
			<!-- <li>
				...
				Speicherplatz und/oder Rechenkapazitäten); <strong>Dienstanbieter:</strong> Hetzner
			...
			<li>
				...
				informationstechnischer Infrastruktur und verbundenen Dienstleistungen (z. B.
				Speicherplatz und/oder Rechenkapazitäten); <strong>Dienstanbieter:</strong> netcup
				GmbH, Daimlerstraße 25, D-76185 Karlsruhe, Deutschland;
				<span class=""
					><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit.
					f) DSGVO);
				</span><strong>Website:</strong>
				<a class="underline text-blue-800" href="https://www.netcup.de/" target="_blank">https://www.netcup.de/</a>;
				<strong>Datenschutzerklärung:</strong>
				<a class="underline text-blue-800" href="https://www.netcup.de/kontakt/datenschutzerklaerung.php" target="_blank"
					>https://www.netcup.de/kontakt/datenschutzerklaerung.php</a
				>. <strong>Auftragsverarbeitungsvertrag:</strong>
				<a class="underline text-blue-800" href="https://helpcenter.netcup.com/de/wiki/general/avv/" target="_blank"
					>https://helpcenter.netcup.com/de/wiki/general/avv/</a
				>.
			</li>
		</ul>
		<h2 id="m134" class="text-3xl">Einsatz von Cookies</h2>
		<p>
		...
		<ul class="list-disc">
			<li>
				<strong>Temporäre Cookies (auch: Session- oder Sitzungscookies):</strong> Temporäre Cookies
			...
			<li>
				...
				Ebenso können die mithilfe von Cookies erhobenen Nutzerdaten zur Reichweitenmessung Verwendung
		...
		<h2 id="m367" class="text-3xl">Registrierung, Anmeldung und Nutzerkonto</h2>
		<p>
		...
		<ul class="list-disc">
			<li>
				...
				Klickpfade, Nutzungsintensität und -frequenz, verwendete Gerätetypen und Betriebssysteme,
				Interaktionen mit Inhalten und Funktionen). Protokolldaten (z. B. Logfiles betreffend
		...
		<ul class="list-disc">
			<li>
				<strong>Registrierung mit Klarnamen: </strong>Aufgrund der Natur unserer Community
			...
			<li>
				<strong>Profile der Nutzer sind nicht öffentlich: </strong>Die Profile der Nutzer
				sind öffentlich nicht sichtbar und nicht zugänglich.
			</li>
			<li>
				<strong>Löschung von Daten nach Kündigung: </strong>Wenn Nutzer ihr Nutzerkonto
		...
		<h2 id="m104" class="text-3xl">Blogs und Publikationsmedien</h2>
		<p>
		...
		<h2 id="m182" class="text-3xl">Kontakt- und Anfrageverwaltung</h2>
		<p>
		...
		<h2 id="m263" class="text-3xl">Webanalyse, Monitoring und Optimierung</h2>
		<p>
		...
		<ul class="list-disc">
			...
			<li>
				...
				von bis zu 2 Jahren (Sofern nicht anders angegeben, können Cookies und ähnliche Speichermethoden
		...
		<h2 id="m135" class="text-3xl">Affiliate-Programme und Affiliate-Links</h2>
		<p>
			In unser Onlineangebot binden wir sogenannte Affiliate-Links oder andere Verweise (zu
			denen z. B. Suchmasken, Widgets oder Rabatt-Codes gehören können) auf die Angebote und
			Leistungen von Drittanbietern ein (zusammenfassend bezeichnet als "Affiliate-Links").
			Wenn Nutzer den Affiliate-Links folgen, bzw. anschließend die Angebote wahrnehmen,
			können wir von diesen Drittanbietern eine Provision oder sonstige Vorteile erhalten
		...
		<p>
			...
			Geschäftsabschlüssen oder zu sonstigen Aktionen (z. B. Käufen) dient alleine dem Zweck
			der Provisionsabrechnung und wird aufgehoben, sobald sie für den Zweck nicht mehr
			erforderlich ist.
		</p>
		<p>
			Für die Zwecke der vorgenannten Zuordnung der Affiliate-Links können die Affiliate-Links
			um bestimmte Werte ergänzt werden, die ein Bestandteil des Links sind oder anderweitig,
			z. B. in einem Cookie, gespeichert werden können. Zu den Werten können insbesondere die
			...
			Angebotes, die Art des verwendeten Links, die Art des Angebotes und eine Online-Kennung
			des Nutzers gehören.
		</p>
		<p>
			<strong>Hinweise zu Rechtsgrundlagen:</strong> Sofern wir die Nutzer um deren Einwilligung
			in den Einsatz der Drittanbieter bitten, ist die Rechtsgrundlage der Verarbeitung von Daten
			die Einwilligung. Ansonsten werden die Daten der Nutzer auf Grundlage unserer berechtigten
			Interessen (d. h. Interesse an effizienten, wirtschaftlichen und empfängerfreundlichen Leistungen)
			verarbeitet. In diesem Zusammenhang möchten wir Sie auch auf die Informationen zur Verwendung
		...
		<ul class="list-disc">
			...
			<li>
				<strong>Betroffene Personen:</strong> Interessenten. Nutzer (z. B. Webseitenbesucher,
		...
		<h2 id="m15" class="text-3xl">Änderung und Aktualisierung</h2>
		<p>
